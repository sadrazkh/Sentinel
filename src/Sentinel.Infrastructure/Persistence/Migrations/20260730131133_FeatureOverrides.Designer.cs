...
namespace Sentinel.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260730131133_FeatureOverrides")]
    partial class FeatureOverrides
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sentinel.Domain.Settings.FeatureOverride", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Sentinel.Vpn.Domain.CustomerService", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("DeliveryTokenHash")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");
                    ...
                    b.Property<DateTimeOffset?>("LastUsageSyncAt")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<string>("PanelClientEmail")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");
                    ...
                    b.HasIndex("DeliveryTokenHash");

                    b.HasIndex("ServerId", "PanelClientEmail")
                        .IsUnique();
            ...
            modelBuilder.Entity("Sentinel.Vpn.Domain.PlanAudienceRule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("PlanAudienceRules", (string)null);
                });

            modelBuilder.Entity("Sentinel.Vpn.Domain.ProvisioningJob", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Sentinel.Vpn.Domain.ServiceInboundBinding", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ServerId", "State");

                    b.HasIndex("ServiceId", "ServerId", "InboundId")
                        .IsUnique();

                    b.ToTable("ServiceInboundBindings", (string)null);
                });

            modelBuilder.Entity("Sentinel.Vpn.Domain.ServiceMigration", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTimeOffset?>("DualActiveSince")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<long>("SourceUsedBytes")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("DestinationServerId", "Step");

                    b.HasIndex("SourceServerId", "Step");

                    b.HasIndex("Step", "NextAttemptAt");

                    b.ToTable("ServiceMigrations", (string)null);
                });

            modelBuilder.Entity("Sentinel.Vpn.Domain.ServicePlan", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ProductId", "IsVisible", "DisplayOrder");
            ...
            modelBuilder.Entity("Sentinel.Vpn.Domain.PlanAudienceRule", b =>
                {
                    b.HasOne("Sentinel.Vpn.Domain.ServicePlan", "Plan")
            ...
            modelBuilder.Entity("Sentinel.Vpn.Domain.ProvisioningJob", b =>
                {
                    b.HasOne("Sentinel.Vpn.Domain.CustomerService", "Service")
                        .WithMany()
