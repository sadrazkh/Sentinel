...
**۲۳۸ تست سبز** (۱۳۵ unit + ۱۰۳ integration).
...
- **اعطا و لغو دسترسی اختصاصی (Entitlement) هنوز UI ندارد.** در صفحهٔ کاربر فقط فهرست
  فقط‌خواندنی نمایش داده می‌شود؛ ویرایش آن کار فاز ۴ است.
- **مدیریت برنامه‌ها UI ندارد.** ساخت و ویرایش `PortalApplication` فعلاً فقط از دیتابیس یا
  seed ممکن است.
